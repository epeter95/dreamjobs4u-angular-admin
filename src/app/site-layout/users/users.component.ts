...
export class UsersComponent implements OnInit {
  ...
  constructor(private dataService: DataService, private roleService: RoleService) {
  }

  ngOnInit(): void {
    this.isSuperAdminUser = this.roleService.getRole() == environment.superAdminRole;
    if(this.isSuperAdminUser){
     this.adminUserOption = {
        name: 'Felhasználók',
        icon: 'supervised_user_circle',
